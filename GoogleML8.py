...
"""
Created on Fri Dec 29 08:16:29 2017

@author: Josh Gordon & Yuliangze 
"""
...
#1. We need to know what question do we need to ask
#2. We need to know when to ask what question

#Impurity:
#   -Chance of being incorrect if randomly assign a label
#       to an example in the same set

#If it is red , it is an apple. Impurity = 0
#If the diamter is >=3, it may be an apple, banna, orange. Impurity will be 1/3
...
#The leaf would be the final branch of the decision tree

#More topics
#Purning
#Handling missing data
#Building trees for regression
#Using trees to explore data sets
